...
@section('content')
    ...
    <div class="card">
        <div class="card-header bg-success text-white">
            ...
            <form action="{{ route('staff.report') }}" method="GET" class="form-inline mb-3">
        ...
        <div class="card-body">
            <div class="table-responsive">
                <table class="table table-sm" id="printTable">
                    ...
                    <tbody>
                        @foreach ($Staff_management as $staff_management)
                            @php
                                $totalPresent = 0;
                                $totalAbsent = 0;
                                $totalDays = 0;
                            @endphp
                            <input type="hidden" name="trainer" value="{{ $staff_management->id }}">
                            <tr>
                                ...
                                @foreach ($dates as $date_picker)
                                    @php
                                        $check_attd = \App\Models\Staff_attendance::query()
                                            ->where('staff_management__id', $staff_management->id)
                    ...
                    <tbody>
                        @foreach ($students as $student)
                            ...
                            <tr>
                                ...
                                <td>{{ $student->staff_management__id }}</td>
   ...
   <div class="card">
    <div class="card-header bg-success text-white d-flex justify-content-between align-items-center">
        <span>Trainer Salary</span>

        <form action="{{ url('trainer/export') }}" method="GET" class="row gx-2 align-items-end mb-0">
            <div class="col-auto">
                    ...
                    <tbody>
                        @foreach ($Staff_management as $staff_management)
                            @php
                                ...
                                $perDaySalary = $staff_management->salary / count($dates);
